...
def load_dataset_off(img_list, height, width, is_train, batch_size=32):
    """
...
def get_img_list_off(data_dir, classes):
    tot_files = []
    dir_list = []
    perm = []
...
def get_split_off(data_dir, classes, split_perc, h, w, batch_size=32):  
    """
